...
func.func @single_qdq(%arg0: tensor<1x1x7x7xf32>) -> tensor<1x1x7x7xf32> {
  %0 = xten_nn.quantize(%arg0 : tensor<1x1x7x7xf32>) {shift = -3 : si32} -> tensor<1x1x7x7xi8>
  %1 = xten_nn.dequantize(%0 : tensor<1x1x7x7xi8>) {shift = -3 : si32} -> tensor<1x1x7x7xf32>
...
func.func @single_concat_at_input(%arg0: tensor<1x1x7x7xf32>) -> tensor<1x2x7x7xf32> {
  ...
  %1 = xten_nn.quantize(%0 : tensor<1x2x7x7xf32>) {shift = -3 : si32} -> tensor<1x2x7x7xi8>
