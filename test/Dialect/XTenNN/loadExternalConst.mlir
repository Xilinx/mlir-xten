...
func.func @valid_LEC_op_bf16() -> tensor<1x2xbf16> {
    %result = xten_nn.load_external_const { key = "myLayerName", file = "quant_params.h5"} -> tensor<1x2xbf16>
...
func.func @invalid_key(%arg0: tensor<1x2xsi8>) -> tensor<1x2xf32> {
    ...
    %result = xten_nn.load_external_const { key = 12.0 : f32, file = "quant_params.h5"} -> tensor<1x2xf32>
    return %result : tensor<1x2xf32>
}