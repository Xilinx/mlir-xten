...
func.func @valid_quantize_op_signed(%arg0: tensor<1x2xf32>) -> tensor<1x2xi8> {
    %result = xten_nn.quantize (%arg0: tensor<1x2xf32>) {shift = -3: si32, scale = 0.125 : f32, zero_point = 0 : i8} -> tensor<1x2xi8>
...
func.func @valid_quantize_op_unsigned(%arg0: tensor<1x2xf32>) -> tensor<1x2xui8> {
    %result = xten_nn.quantize (%arg0: tensor<1x2xf32>) {shift = -3: si32, scale = 0.125 : f32, zero_point = 0 : ui8} -> tensor<1x2xui8>
...
func.func @valid_quantize_op_large_scale(%arg0: tensor<1x2xf32>) -> tensor<1x2xui8> {
    %result = xten_nn.quantize (%arg0: tensor<1x2xf32>) {shift = 5: si32, scale = 32.0 : f32, zero_point = 0 : ui8} -> tensor<1x2xui8>
    return %result : tensor<1x2xui8>
}
...
func.func @invalid_shift(%arg0: tensor<1x2xf32>) -> tensor<1x2xi8> {
    ...
    %result = xten_nn.quantize (%arg0: tensor<1x2xf32>) {shift = 0.135: f32, scale = 0.5 : f32, zero_point = 0 : i8} -> tensor<1x2xi8>
    return %result : tensor<1x2xi8>
}
...
func.func @invalid_tensor_signed(%arg0: tensor<1x2xf32>) -> tensor<1x2xsi8> {
    ...
    %result = xten_nn.quantize (%arg0: tensor<1x2xf32>) {shift = -1: si32, scale = 0.5 : f32, zero_point = 0 : si8} -> tensor<1x2xsi8>
...
func.func @invalid_io_shapes(%arg0: tensor<1x2xf32>) -> tensor<1x3xi8> {
    ...
    %result = xten_nn.quantize (%arg0: tensor<1x2xf32>) {shift = -1: si32, scale = 0.5 : f32, zero_point = 0 : i8} -> tensor<1x3xi8>
...
func.func @invalid_input_type(%arg0: tensor<1x2xi32>) -> tensor<1x2xi8> {
    // expected-error@+1 {{op operand #0 must be tensor of floating-point values, but got 'tensor<1x2xi32>'}}
    %result = xten_nn.quantize (%arg0: tensor<1x2xi32>) {shift = -1: si32, scale = 0.5 : f32, zero_point = 0 : i8} -> tensor<1x2xi8>
    return %result : tensor<1x2xi8>
}
// -----

func.func @different_bitwidth(%arg0: tensor<1x2xf32>) -> tensor<1x2xi3> {
    %result = xten_nn.quantize (%arg0: tensor<1x2xf32>) {shift = -1: si32, scale = 0.5 : f32, zero_point = 0 : i3} -> tensor<1x2xi3>
...
func.func @sixteen_bitwidth(%arg0: tensor<1x2xf32>) -> tensor<1x2xi16> {
    %result = xten_nn.quantize (%arg0: tensor<1x2xf32>) {shift = -1: si32, scale = 0.5 : f32, zero_point = 0 : i16} -> tensor<1x2xi16>
    return %result : tensor<1x2xi16>
}

// -----

func.func @valid_quantize_no_shift(%arg0: tensor<1x2xf32>) -> tensor<1x2xi8> {
    %result = xten_nn.quantize (%arg0: tensor<1x2xf32>) {scale = 0.125 : f32, zero_point = 3 : i8} -> tensor<1x2xi8>
    return %result : tensor<1x2xi8>
}
...
func.func @quantize_op_scale_shift_mismatch(%arg0: tensor<1x2xf32>) -> tensor<1x2xui8> {
     // expected-error@+1 {{Shift set, but does not match shift calculated from scale}}
    %result = xten_nn.quantize (%arg0: tensor<1x2xf32>) {shift = 5: si32, scale = 31.0 : f32, zero_point = 0 : ui8} -> tensor<1x2xui8>
    return %result : tensor<1x2xui8>
}

// -----

func.func @quantize_op_zero_not_zero(%arg0: tensor<1x2xf32>) -> tensor<1x2xui8> {
    // expected-error@+1 {{Shift set, but zero_point not zero}}
    %result = xten_nn.quantize (%arg0: tensor<1x2xf32>) {shift = 5: si32, scale = 32.0 : f32, zero_point = 1 : ui8} -> tensor<1x2xui8>
    return %result : tensor<1x2xui8>
}