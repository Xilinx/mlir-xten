...
// CHECK-SAME: torch.onnx.coordinate_transformation_mode = "half_pixel"
// CHECK-SAME: torch.onnx.mode = "nearest"
// CHECK-SAME: torch.onnx.nearest_mode = "floor"
// CHECK-SAME: : (!torch.vtensor<[1,256,16,16],f32>, !torch.none, !torch.vtensor<[4],f32>) -> !torch.vtensor<[1,256,32,32],f32>
// CHECK:    %[[TO:.*]] = torch_c.to_builtin_tensor %[[RESIZE]] : !torch.vtensor<[1,256,32,32],f32> -> tensor<1x256x32x32xf32>
// CHECK:    return %[[TO]] : tensor<1x256x32x32xf32>

// -----

func.func @resize_nearest_round_prefer_floor(%arg0: tensor<1x256x16x16xf32>) -> tensor<1x256x32x32xf32> {
    %1 = xten_nn.resize %arg0 {coordinate_transformation_mode = 0 : i64, mode = 0 : i64, nearest_mode = 2 : i64, scales = array<f32: 1.000000e+00, 1.000000e+00, 2.000000e+00, 2.000000e+00>} : (tensor<1x256x16x16xf32>) -> tensor<1x256x32x32xf32>
    return %1 : tensor<1x256x32x32xf32>
}
// CHECK-LABEL:  func.func @resize_nearest
// CHECK-SAME:          (%[[ARG:.*]]: tensor<1x256x16x16xf32>) -> tensor<1x256x32x32xf32> attributes {torch.onnx_meta.opset_version = 19 : si64} {
...
// CHECK-SAME: torch.onnx.coordinate_transformation_mode = "half_pixel"
// CHECK-SAME: torch.onnx.mode = "nearest"
// CHECK-SAME: torch.onnx.nearest_mode = "round_prefer_floor"
// CHECK-SAME: : (!torch.vtensor<[1,256,16,16],f32>, !torch.none, !torch.vtensor<[4],f32>) -> !torch.vtensor<[1,256,32,32],f32>
// CHECK:    %[[TO:.*]] = torch_c.to_builtin_tensor %[[RESIZE]] : !torch.vtensor<[1,256,32,32],f32> -> tensor<1x256x32x32xf32>
// CHECK:    return %[[TO]] : tensor<1x256x32x32xf32>
