//===- xten_to_linalg_conv2d_relu_pad_maxpool.mlir -------------------------------*- MLIR -*-===//
//
...
module attributes {torch.debug_module_name = "HelloWorld"}  {
  func.func @forward(%arg0: !torch.vtensor<[1,3,128,128],f32>) -> !torch.vtensor<[1,16,64,64],f32> {
    ...
    %5 = torch.prim.ListConstruct %int0, %int1, %int0, %int1 : (!torch.int, !torch.int, !torch.int, !torch.int) -> !torch.list<int>
    %6 = "xten.conv2d_relu_pad_maxpool"(%arg0, %1, %0, %2, %2, %2, %int1, %5, %float-Inf, %3, %3, %4, %2, %false) {layer_name = "conv2d_relu_pad_maxpool0"} : (!torch.vtensor<[1,3,128,128],f32>, !torch.vtensor<[16,3,3,3],f32>, !torch.vtensor<[16],f32>, !torch.list<int>, !torch.list<int>, !torch.list<int>, !torch.int, !torch.list<int>, !torch.float, !torch.list<int>, !torch.list<int>, !torch.list<int>, !torch.list<int>, !torch.bool) -> !torch.vtensor<[1,16,64,64],f32>
