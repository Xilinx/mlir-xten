...
module attributes {torch.debug_module_name = "model"}  {
  func @forward(%arg0: !torch.vtensor<[1,27,49,42],f32>, %arg1: !torch.vtensor<[28,27,3,3],f32>, %arg2: !torch.vtensor<[28],f32>) -> !torch.vtensor<[1,28,45,40],f32> {
    ...
    %5 = "xten.conv2d"(%arg0, %arg1, %arg2, %2, %3, %4, %int1) {layer_name = "conv2d"} : (!torch.vtensor<[1,27,49,42],f32>, !torch.vtensor<[28,27,3,3],f32>, !torch.vtensor<[28],f32>, !torch.list<int>, !torch.list<int>, !torch.list<int>, !torch.int) -> !torch.vtensor<[1,28,45,40],f32>
