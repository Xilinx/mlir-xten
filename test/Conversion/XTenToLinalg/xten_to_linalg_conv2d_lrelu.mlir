...
module attributes {torch.debug_module_name = "HelloWorld"}  {
  func @forward(%arg0: !torch.vtensor<[1,3,128,128],f32>) -> !torch.vtensor<[1,16,128,128],f32> {
    ...
    %3 = "xten.conv2d_lrelu"(%arg0, %1, %0, %2, %2, %2, %int1, %float1.000000e-01) {layer_name = "conv2d_lrelu0"} : (!torch.vtensor<[1,3,128,128],f32>, !torch.vtensor<[16,3,3,3],f32>, !torch.vtensor<[16],f32>, !torch.list<!torch.int>, !torch.list<!torch.int>, !torch.list<!torch.int>, !torch.int, !torch.float) -> !torch.vtensor<[1,16,128,128],f32>
