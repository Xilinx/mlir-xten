...
module  {
  func @myFunc(%arg0: !torch.vtensor<[128,128],si32>, %arg1: !torch.vtensor<[128,128],si32>) -> !torch.vtensor<[?,?],si32> {
    %0 = "xten.mm"(%arg0, %arg1) : (!torch.vtensor<[128,128],si32>, !torch.vtensor<[128,128],si32>) -> !torch.vtensor<[?,?],si32>
