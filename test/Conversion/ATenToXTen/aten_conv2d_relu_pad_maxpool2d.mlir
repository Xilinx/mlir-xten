...
module attributes {torch.debug_module_name = "model"} {
  func.func @forward(%arg0: !torch.vtensor<[1,3,224,224],f32>) -> !torch.vtensor<[1,64,56,56],f32> {
    ...
    %5 = torch.aten.convolution %arg0, %1, %0, %2, %4, %3, %false, %empty_list, %int1 : !torch.vtensor<[1,3,224,224],f32>, !torch.vtensor<[64,3,7,7],f32>, !torch.vtensor<[64],f32>, !torch.list<int>, !torch.list<int>, !torch.list<int>, !torch.bool, !torch.list<int>, !torch.int -> !torch.vtensor<[1,64,112,112],f32>
    %6 = torch.aten.relu %5 : !torch.vtensor<[1,64,112,112],f32> -> !torch.vtensor<[1,64,112,112],f32>
    %7 = torch.prim.ListConstruct %int0, %int1, %int0, %int1 : (!torch.int, !torch.int, !torch.int, !torch.int) -> !torch.list<int>
    %8 = torch.aten.constant_pad_nd %6, %7, %float-3.402820e38 : !torch.vtensor<[1,64,112,112],f32>, !torch.list<int>, !torch.float -> !torch.vtensor<[1,64,113,113],f32>
    %9 = torch.prim.ListConstruct %int0, %int0 : (!torch.int, !torch.int) -> !torch.list<int>
    %10 = torch.aten.max_pool2d %8, %4, %2, %9, %3, %false : !torch.vtensor<[1,64,113,113],f32>, !torch.list<int>, !torch.list<int>, !torch.list<int>, !torch.list<int>, !torch.bool -> !torch.vtensor<[1,64,56,56],f32>
