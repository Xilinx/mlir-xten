...
// CHECK:   %2 = "xten.conv2d_tensoradd_relu"(%arg0, %0, %none, %1, %1, %1, %int1, %arg0) : (!torch.vtensor<[1,2,128,128],f32>, !torch.vtensor<[16,2,3,3],f32>, !torch.none, !torch.list<int>, !torch.list<int>, !torch.list<int>, !torch.int, !torch.vtensor<[1,2,128,128],f32>) -> !torch.vtensor<[1,2,128,128],f32>
