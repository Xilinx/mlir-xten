//===- aten_conv2d_relu_maxpool2d.mlir ---------------------------------*- MLIR -*-===//
//
...
// CHECK: [[FUSED:%.]] = "xten.conv2d_relu_maxpool"(%arg0, [[WGTS]], [[BIAS]], [[LIST1]], [[LIST1]], [[LIST1]], %int1, [[LIST2]], [[LIST2]], [[LIST0]], [[LIST1]], %false) {layer_name = "Conv_0"} : (!torch.vtensor<[1,2,128,128],f32>, !torch.vtensor<[16,2,1,1],f32>, !torch.vtensor<[16],f32>, !torch.list<int>, !torch.list<int>, !torch.list<int>, !torch.int, !torch.list<int>, !torch.list<int>, !torch.list<int>, !torch.list<int>, !torch.bool) -> !torch.vtensor<[1,16,65,65],f32>
...
module attributes {torch.debug_module_name = "model"}  {
  func.func @forward(%arg0: !torch.vtensor<[1,2,128,128],f32>) -> !torch.vtensor<[1,16,65,65],f32> {
    ...
    %lrelu = torch.aten.relu %c2d {layer_name = "Relu_0"} : !torch.vtensor<[1,16,130,130],f32> -> !torch.vtensor<[1,16,130,130],f32>
    %pool = torch.aten.max_pool2d  %lrelu, %list2, %list2, %list0, %list1, %false {layer_name = "Maxpool_0"} : !torch.vtensor<[1,16,130,130],f32>, !torch.list<int>, !torch.list<int>, !torch.list<int>, !torch.list<int>, !torch.bool -> !torch.vtensor<[1,16,65,65],f32>
