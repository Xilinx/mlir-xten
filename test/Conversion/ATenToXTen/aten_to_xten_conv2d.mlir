...
// CHECK: %4 = "xten.conv2d"(%arg0, %1, %0, %2, %3, %2, %int1) : (!torch.vtensor<[1,2,128,128],f32>, !torch.vtensor<[8,1,3,3],f32>, !torch.vtensor<[8],f32>, !torch.list<int>, !torch.list<int>, !torch.list<int>, !torch.int) -> !torch.vtensor<[1,8,126,126],f32>

module attributes {torch.debug_module_name = "conv2d"} {
  func.func @forward(%arg0: !torch.vtensor<[1,2,128,128],f32>) -> !torch.vtensor<[1,8,126,126],f32> {
    ...
    %4 = torch.aten.conv2d %arg0, %1, %0, %2, %3, %2, %int1 : !torch.vtensor<[1,2,128,128],f32>, !torch.vtensor<[8,1,3,3],f32>, !torch.vtensor<[8],f32>, !torch.list<int>, !torch.list<int>, !torch.list<int>, !torch.int -> !torch.vtensor<[1,8,126,126],f32>
