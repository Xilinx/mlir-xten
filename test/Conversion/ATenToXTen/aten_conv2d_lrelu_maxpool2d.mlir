...
// CHECK: [[FUSED:%.]] = "xten.conv2d_lrelu_maxpool"(%arg0, [[WGTS]], [[BIAS]], [[LIST1]], [[LIST1]], [[LIST1]], %int1, %float2.320000e-01, [[LIST2]], [[LIST2]], [[LIST0]], [[LIST1]], %false) {layer_name = "Conv_0"} : (!torch.vtensor<[1,2,128,128],f32>, !torch.vtensor<[16,2,1,1],f32>, !torch.vtensor<[16],f32>, !torch.list<int>, !torch.list<int>, !torch.list<int>, !torch.int, !torch.float, !torch.list<int>, !torch.list<int>, !torch.list<int>, !torch.list<int>, !torch.bool) -> !torch.vtensor<[1,16,65,65],f32>
