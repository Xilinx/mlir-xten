...
// CHECK:             %[[VAL_1:.*]] = xten_nn.quantize(%[[VAL_0]] : tensor<1x3x4x4xf32>) {scale = 3.125000e-02 : f32, shift = -5 : si32, zero_point = 0 : i8} -> tensor<1x3x4x4xi8>
// CHECK:             %[[VAL_2:.*]] = xten_nn.dequantize(%[[VAL_1]] : tensor<1x3x4x4xi8>) {scale = 3.125000e-02 : f32, shift = -5 : si32, zero_point = 0 : i8} -> tensor<1x3x4x4xf32>
...
// CHECK:             %[[VAL_1:.*]] = "tosa.const"() <{value = dense<3.125000e-02> : tensor<1x1x1x1xf32>}> : () -> tensor<1x1x1x1xf32>
// CHECK:             %[[VAL_2:.*]] = xten_nn.dequantize(%[[VAL_0]] : tensor<1x3x4x4xi8>) {scale = 1.000000e+00 : f32, shift = 0 : si32, zero_point = 0 : i8} -> tensor<1x3x4x4xf32>
...
// CHECK:           }
  func.func @mul_missing_quantize(%arg0: tensor<1x3x4x4xi8>) -> tensor<1x3x4x4xf32> {
    %0 = "tosa.const"() {value = dense<3.125000e-02> : tensor<1x1x1x1xf32>} : () -> tensor<1x1x1x1xf32>
    %1 = xten_nn.dequantize(%arg0 : tensor<1x3x4x4xi8>) {scale = 1.000000e+00 : f32, shift = 0 : si32, zero_point = 0 : i8}  -> tensor<1x3x4x4xf32>
...
// CHECK:             %[[VAL_4:.*]] = xten_nn.quantize(%[[VAL_3]] : tensor<1x3x4x4xf32>) {scale = 1.000000e+00 : f32, shift = 0 : si32, zero_point = 0 : i8} -> tensor<1x3x4x4xi8>
// CHECK:             %[[VAL_5:.*]] = xten_nn.dequantize(%[[VAL_4]] : tensor<1x3x4x4xi8>) {scale = 1.000000e+00 : f32, shift = 0 : si32, zero_point = 0 : i8} -> tensor<1x3x4x4xf32>
...
// CHECK:           }
  func.func @unequal_mul_constants(%arg0: tensor<1x3x4x4xf32>) -> tensor<1x3x4x4xf32> {
    ...
    %3 = xten_nn.quantize(%2 : tensor<1x3x4x4xf32>) {scale = 1.000000e+00 : f32, shift = 0 : si32, zero_point = 0 : i8}  -> tensor<1x3x4x4xi8>
    %4 = xten_nn.dequantize(%3 : tensor<1x3x4x4xi8>) {scale = 1.000000e+00 : f32, shift = 0 : si32, zero_point = 0 : i8}  -> tensor<1x3x4x4xf32>
...
// CHECK:             %[[VAL_2:.*]] = tosa.mul %[[VAL_0]], %[[VAL_1]] {shift = 0 : i8} : (tensor<1x3x4x4xf32>, tensor<1x1x1x1xf32>) -> tensor<1x3x4x4xf32>
// CHECK:             %[[VAL_3:.*]] = xten_nn.quantize(%[[VAL_2]] : tensor<1x3x4x4xf32>) {scale = 1.000000e+00 : f32, shift = 0 : si32, zero_point = 0 : i8} -> tensor<1x3x4x4xi8>
// CHECK:             %[[VAL_4:.*]] = xten_nn.dequantize(%[[VAL_3]] : tensor<1x3x4x4xi8>) {scale = 1.000000e+00 : f32, shift = 0 : si32, zero_point = 0 : i8} -> tensor<1x3x4x4xf32>
...
// CHECK-SAME:                            %[[VAL_0:.*]]: tensor<1x3x4x4xf32>) -> tensor<1x3x4x4xf32> {
// CHECK:             %[[VAL_1:.*]] = xten_nn.quantize(%[[VAL_0]] : tensor<1x3x4x4xf32>) {scale = 2.500000e-01 : f32, shift = -2 : si32, zero_point = 0 : i8} -> tensor<1x3x4x4xi8>
// CHECK:             %[[VAL_2:.*]] = xten_nn.dequantize(%[[VAL_1]] : tensor<1x3x4x4xi8>) {scale = 2.500000e-01 : f32, shift = -2 : si32, zero_point = 0 : i8} -> tensor<1x3x4x4xf32>
// CHECK:             return %[[VAL_2]] : tensor<1x3x4x4xf32>
// CHECK:           }
...
// CHECK:             %[[VAL_3:.*]] = "tosa.const"() <{value = dense<3.125000e-02> : tensor<1x1x1x1xf32>}> : () -> tensor<1x1x1x1xf32>
// CHECK:             %[[VAL_4:.*]] = tosa.mul %[[VAL_0]], %[[VAL_2]] {shift = 0 : i8} : (tensor<1x3x4x4xf32>, tensor<1x1x1x1xf32>) -> tensor<1x3x4x4xf32>
// CHECK:             %[[VAL_5:.*]] = xten_nn.quantize(%[[VAL_4]] : tensor<1x3x4x4xf32>) {scale = 1.000000e+00 : f32, shift = 0 : si32, zero_point = 0 : i8} -> tensor<1x3x4x4xi8>
// CHECK:             %[[VAL_6:.*]] = xten_nn.dequantize(%[[VAL_5]] : tensor<1x3x4x4xi8>) {scale = 1.000000e+00 : f32, shift = 0 : si32, zero_point = 0 : i8} -> tensor<1x3x4x4xf32>
// CHECK:             %[[VAL_7:.*]] = tosa.mul %[[VAL_6]], %[[VAL_3]] {shift = 0 : i8} : (tensor<1x3x4x4xf32>, tensor<1x1x1x1xf32>) -> tensor<1x3x4x4xf32>
...
// CHECK-SAME:                                  %[[VAL_0:.*]]: tensor<1x3x4x4xf32>,
// CHECK-SAME:                                  %[[VAL_1:.*]]: tensor<1x3x4x4xf32>) -> (tensor<1x3x4x4xf32>, tensor<1x3x4x4xf32>) {
// CHECK:             %[[VAL_2:.*]] = xten_nn.quantize(%[[VAL_0]] : tensor<1x3x4x4xf32>) {scale = 1.000000e+00 : f32, shift = 0 : si32, zero_point = 0 : i8} -> tensor<1x3x4x4xi8>
// CHECK:             %[[VAL_3:.*]] = xten_nn.dequantize(%[[VAL_2]] : tensor<1x3x4x4xi8>) {scale = 1.000000e+00 : f32, shift = 0 : si32, zero_point = 0 : i8} -> tensor<1x3x4x4xf32>
...
// CHECK-SAME:                                      %[[VAL_0:.*]]: tensor<1x3x4x4xf32>,
// CHECK-SAME:                                      %[[VAL_1:.*]]: tensor<1x3x4x4xf32>) -> (tensor<1x3x4x4xf32>, tensor<1x3x4x4xf32>) {
// CHECK:             %[[VAL_2:.*]] = xten_nn.quantize(%[[VAL_0]] : tensor<1x3x4x4xf32>) {scale = 3.125000e-02 : f32, shift = -5 : si32, zero_point = 0 : i8} -> tensor<1x3x4x4xi8>
// CHECK:             %[[VAL_3:.*]] = xten_nn.dequantize(%[[VAL_2]] : tensor<1x3x4x4xi8>) {scale = 3.125000e-02 : f32, shift = -5 : si32, zero_point = 0 : i8} -> tensor<1x3x4x4xf32>
// CHECK:             %[[VAL_4:.*]] = tosa.add %[[VAL_1]], %[[VAL_3]] : (tensor<1x3x4x4xf32>, tensor<1x3x4x4xf32>) -> tensor<1x3x4x4xf32>
// CHECK:             return %[[VAL_3]], %[[VAL_4]] : tensor<1x3x4x4xf32>, tensor<1x3x4x4xf32>
// CHECK:           }
...
// CHECK:             %[[VAL_4:.*]] = xten_nn.quantize(%[[VAL_3]] : tensor<4x3xf32>) {scale = 1.000000e+00 : f32, shift = 0 : si32, zero_point = 0 : i8} -> tensor<4x3xi8>
// CHECK:             %[[VAL_5:.*]] = xten_nn.dequantize(%[[VAL_4]] : tensor<4x3xi8>) {scale = 1.000000e+00 : f32, shift = 0 : si32, zero_point = 0 : i8} -> tensor<4x3xf32>
...
// CHECK:             %[[VAL_4:.*]] = xten_nn.quantize(%[[VAL_3]] : tensor<1x3xf32>) {scale = 1.000000e+00 : f32, shift = 0 : si32, zero_point = 0 : i8} -> tensor<1x3xi8>
// CHECK:             %[[VAL_5:.*]] = xten_nn.dequantize(%[[VAL_4]] : tensor<1x3xi8>) {scale = 1.000000e+00 : f32, shift = 0 : si32, zero_point = 0 : i8} -> tensor<1x3xf32>
...
// CHECK:             %[[VAL_1:.*]] = xten_nn.quantize(%[[VAL_0]] : tensor<1x3x4x4xf32>) {scale = 7.812500e-03 : f32, shift = -7 : si32, zero_point = 0 : i8} -> tensor<1x3x4x4xi8>
// CHECK:             %[[VAL_2:.*]] = xten_nn.dequantize(%[[VAL_1]] : tensor<1x3x4x4xi8>) {scale = 7.812500e-03 : f32, shift = -7 : si32, zero_point = 0 : i8} -> tensor<1x3x4x4xf32>
// CHECK:             return %[[VAL_2]] : tensor<1x3x4x4xf32>
// CHECK:           }
 func.func @fold_after_sort_on_mul() -> tensor<1x3x4x4xf32> {
    ...
    %4 = xten_nn.quantize(%3 : tensor<1x3x4x4xf32>) {scale = 1.000000e+00 : f32, shift = 0 : si32, zero_point = 0 : i8} -> tensor<1x3x4x4xi8>
    %5 = xten_nn.dequantize(%4 : tensor<1x3x4x4xi8>) {scale = 1.000000e+00 : f32, shift = 0 : si32, zero_point = 0 : i8} -> tensor<1x3x4x4xf32>
