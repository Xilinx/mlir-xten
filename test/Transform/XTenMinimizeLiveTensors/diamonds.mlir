...
// CHECK:     "conv2d1"
// CHECK:     "add1"
func.func @legal_dead_code(%arg0: !torch.vtensor<[1,64,56,56],f32>) -> !torch.vtensor<[1,256,56,56],f32> {
  %int0 = torch.constant.int 0
  %int1 = torch.constant.int 1
  %1 = torch.vtensor.literal(dense<0.00999999977> : tensor<64xf32>) : !torch.vtensor<[64],f32>
  %2 = torch.vtensor.literal(dense<2.000000e-02> : tensor<64x64x1x1xf32>) : !torch.vtensor<[64,64,1,1],f32>
  ...
  %35 = "xten.add"(%arg0, %arg0) {layer_name = "add0"} : (!torch.vtensor<[1,64,56,56],f32>, !torch.vtensor<[1,64,56,56],f32>) -> !torch.vtensor<[1,64,56,56],f32>
