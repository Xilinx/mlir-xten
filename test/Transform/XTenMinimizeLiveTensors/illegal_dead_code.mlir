...
func.func @illegal_dead_code(%arg0: !torch.vtensor<[1,64,56,56],f32>) -> !torch.vtensor<[1,256,56,56],f32> {
  ...
  %36 = "xten.conv2d_tensoradd_relu"(%arg0, %4, %5, %29, %32, %29, %int1, %34) {layer_name = "conv2d_tensoradd_relu1"} : (!torch.vtensor<[1,64,56,56],f32>, !torch.vtensor<[256,64,1,1],f32>, !torch.vtensor<[256],f32>, !torch.list<int>, !torch.list<int>, !torch.list<int>, !torch.int, !torch.vtensor<[1,256,56,56],f32>) -> !torch.vtensor<[1,256,56,56],f32>
  %37 = "xten.add"(%33, %34) {layer_name = "add0"} : (!torch.vtensor<[1,256,56,56],f32>, !torch.vtensor<[1,256,56,56],f32>) -> !torch.vtensor<[1,256,56,56],f32>
