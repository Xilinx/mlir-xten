...
module attributes {torch.debug_module_name = "TinyYoloV2"}  {
  func @forward(%arg0: !torch.vtensor<[1,3,416,416],f32>) -> !torch.vtensor<[?,?,?,?],f32> {
    ...
    %13 = torch.aten.max_pool2d %8, %9, %10, %11, %12, %false {layer_name = "max_pool2d0"} : !torch.vtensor, !torch.list<int>, !torch.list<int>, !torch.list<int>, !torch.list<int>, !torch.bool -> !torch.vtensor<[?,?,?,?],unk>
